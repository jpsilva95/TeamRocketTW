...
// @grant        GM_xmlhttpRequest// ==UserScript==
// @name         Mystery Inc. Dailies (v8.6 Turbo)
// @namespace    http://tampermonkey.net
// @version      8.6
// @description  Send daily farm, resource stats, and troop counts to Discord (Forces 1000 villages/page for speed)
// @author       Mystery Inc.
// @match        https://*.tribalwars.com.pt/game.php*
// @match        https://*.tribalwars.net/game.php*
// @match        https://*.tribalwars.com/game.php*
    ...
    class TwDailyStats {
        ...
        async fetchTroopCounts(baseUrl, search, stats, config) {
            ...
            if (config.scavenging) {
                ...
                // (Usually paginates efficiently already, so we loop safely)
